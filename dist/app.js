...
/* harmony import */ var _Users_chenguochen_Desktop_projects_part_time_sap_wx_node_modules_remax_plugin_error_screen_lib_ErrorScreen_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28);
...
/* harmony import */ var _Users_chenguochen_Desktop_projects_part_time_sap_wx_node_modules_remax_plugin_error_screen_lib_ErrorBoundary_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(29);
...
var pluginDriver=new esm["a" /* PluginDriver */]([__webpack_require__(43)].map(function(p){return p.default||p;}));esm["b" /* RuntimeOptions */].apply({platform:"wechat",debug:false,pxToRpx:true,pluginDriver:pluginDriver,hostComponents:_remax_runtime_options_["hostComponents"],pageEvents:_remax_runtime_options_["pageEvents"],appEvents:_remax_runtime_options_["appEvents"]});
...
var anna = __webpack_require__(44);
...
__webpack_require__(24);App(Object(esm["c" /* createAppConfig */])(src_app));
